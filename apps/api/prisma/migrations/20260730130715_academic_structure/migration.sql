...
-- CreateIndex
CREATE UNIQUE INDEX "Section_academicYearId_classId_name_key" ON "Section"("academicYearId", "classId", "name");
...
-- CreateIndex
CREATE UNIQUE INDEX "StudentEnrollment_academicYearId_studentId_key" ON "StudentEnrollment"("academicYearId", "studentId");
